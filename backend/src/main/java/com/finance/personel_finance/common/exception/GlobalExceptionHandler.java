...
public class GlobalExceptionHandler {
    ...
    // 502 - upstream API hatası (market rates vb.)
    ...
    // 400 - Dosya boyutu çok büyük
    @ExceptionHandler(MaxUploadSizeExceededException.class)
    public ResponseEntity<ErrorResponse> handleMaxSizeException(MaxUploadSizeExceededException exc, HttpServletRequest req) {
        return build(HttpStatus.BAD_REQUEST, "Dosya boyutu çok büyük! Lütfen daha küçük bir resim seçin (Maksimum 10MB).", req.getRequestURI());
    }
